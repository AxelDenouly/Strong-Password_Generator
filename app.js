function getRandomNumber(min,max){
  ...
  rangeLabel.textContent = `Size of the password : ${range.value}`
  ...
  function createPassword(){
    ...
    if(!checkedDataSets.length){
      errorMsg.textContent = "Check at least one box !"
      return;
    }
  ...
  function handleRange(e){
    ...
    rangeLabel.textContent = `Size of the password : ${passwordLength}`
  }
